...
{
    [Header("Wayfinding")]
    public GameObject m_AttractionPoint;
    ...
    void Awake()
    {
        ...
        m_StartObject = GameObject.FindGameObjectWithTag("GuideStart");
    ...
    {
        ClampPositionAndUpdateTarget();
        m_StartObject.GetComponentInChildren<SelfGuidingFire>().UpdateGuidingDestination(m_AttractionPoint);
